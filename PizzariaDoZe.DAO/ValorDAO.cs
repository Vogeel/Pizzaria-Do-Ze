...
namespace PizzariaDoZe.DAO
{
    ...
    public class ValorDAO
    {
        ...
        public DataTable Buscar(Valor valor)
        {
            ...
            conexao.Open();
            comando.CommandText = @" " + "SELECT id_valor AS ID, tamanho AS Tamanho, categoria AS Categoria, valor AS Valor, valor_borda AS 'Valor Borda' " +
            "FROM tb_valor AS v " + auxSqlFiltro +";";
